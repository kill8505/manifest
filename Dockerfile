...
##   $ docker build -t java-for-kill8505-manifest .
##
## RUNNING
##   $ docker run java-for-kill8505-manifest

FROM gcr.io/bitnami-containers/minideb-extras:jessie-r12-buildpack

MAINTAINER Bitnami <containers@bitnami.com>

ENV STACKSMITH_STACK_ID="urrkvnv" \
    STACKSMITH_STACK_NAME="Java for kill8505/manifest" \
